...
FILE_SIZE_LIMIT_MB = 26 # My internet pls
...
async def on_ready():
    ...
    await client.change_presence(activity=discord.Activity(type=discord.ActivityType.playing, name=f"in {server_count} servers"))

intents.typing = False
intents.presences = False
# intents.members = False
discord_status = discord.Game('in {server_count} servers')
status=discord.Status.idle  # Can be online, idle, dnd (do not disturb), or invisibleb
...
async def parse_command(message):
    ...
    cmd_name_opts = ["concat", "combine", "download", "downloader", "beb"]
    ...
    match final_command_name:
        ...
        case "klaskysource":
            await message.reply("https://cdn.discordapp.com/attachments/1124758334805909509/1314401906759696447/InShot_20240427_154028054.mp4?ex=6753a3aa&is=6752522a&hm=5893fe40b4624f2f0730a70a40ef02e396be8b53b04b4470a9a88ad596330a63&",)
        case "concat":
            Task(
